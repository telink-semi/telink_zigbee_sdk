class Settings:
    ...
    def __init__(self):
        ...
        self.hci_command_list = {
            ...
            0x8035: 'ZBHCI_CMD_MGMT_NWK_UPDATE_NOTIFY',

            0x0040: 'ZBHCI_CMD_NODES_JOINED_GET_REQ',
            0x0041: 'ZBHCI_CMD_NODES_TOGGLE_TEST_REQ',
            ...
            0x8041: 'ZBHCI_CMD_NODES_TOGGLE_TEST_RSP',
            ...
            0x0220: 'ZBHCI_CMD_ZCL_ZDD_SET_STATE',
            0x0221: 'ZBHCI_CMD_ZCL_ZDD_SET_ANJ_TIME',
            0x8220: 'ZBHCI_CMD_ZCL_ZDD_SET_STATE_RESPONSE',
        }
