...
unsigned char AMIC_ADC_SampleLength[3] = {
    0xf0/*96K*/,
    0xac/*132K*/,
    0x75/*192K*/
};
...
#define WM8731_ANA_AUDIO_PATH_CTRL              0x08 //Analog Audio Path Control
...
void audio_set_codec(I2C_GPIO_GroupTypeDef i2c_pin_group, CodecMode_Typedef CodecMode, unsigned int sysclk)
{
    ...
    i2c_set_id(0x34);
    i2c_master_init((unsigned char)(sysclk / (4 * 200000))); //i2c clock 200K, only master need set i2c clock
