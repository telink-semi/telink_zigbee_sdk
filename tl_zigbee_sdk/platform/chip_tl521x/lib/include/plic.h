...
#define IRQ_I3C0               12 /* IRQ_I3C0,  - i3c0_irq_handler */
#define IRQ_DC                 13 /* IRQ_DC, - dc_irq_handler */
#define IRQ_UART2              14 /* UART2_IRQ, - uart2_irq_handler */
...
#define IRQ_IR_LEARN           26 /* IR_LEARN_IRQ - ir_learn_irq_handler */
#define IRQ_KEY_SCAN           27 /* KEY_SCAN_IRQ, - key_scan_irq_handler */
...
#define IRQ_LPD                46 /* LPD_IRQ, - lpd_irq_handler */
#define IRQ_GSPI1              47 /* IRQ_GSPI1, - gspi1_irq_handler */
#define IRQ_UART3              48 /* UART3_IRQ, - uart3_irq_handler */
#define IRQ_CAN0               49 /* IRQ_CAN0,  - can0_irq_handler */
#define IRQ_UART4              50 /* UART4_IRQ, - uart4_irq_handler */
