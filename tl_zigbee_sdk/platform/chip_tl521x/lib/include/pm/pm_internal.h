...
static _always_inline void pm_24mrc_power_up(void)
{
    if (!g_24m_rc_is_used) {
        ...
        analog_write_reg8(areg_aon_0x05, g_areg_aon_05); // power on 24M RC
...
static _always_inline void pm_24mrc_power_down_if_unused(void)
{
    if (!g_24m_rc_is_used) {
        g_areg_aon_05 |= FLD_24M_RC_PD;
        analog_write_reg8(areg_aon_0x05, g_areg_aon_05); // power down 24M RC
    }
}
...
/**
 * @brief      This function servers to get calibration value from EFUSE for dig ldo voltage.
