...
void uart_set_pin(uart_num_e uart_num, gpio_func_pin_e tx_pin, gpio_func_pin_e rx_pin)
{
    ...
    if (tx_pin != GPIO_NONE_PIN) {
        ...
        gpio_set_up_down_res((gpio_pin_e)tx_pin, GPIO_PIN_PULLUP_20K);
        switch (uart_num) {
        case UART0:
    ...
    if (rx_pin != GPIO_NONE_PIN) {
        ...
        gpio_set_up_down_res((gpio_pin_e)rx_pin, GPIO_PIN_PULLUP_20K);
        switch (uart_num) {
        case UART0:
...
void uart_set_rtx_pin(uart_num_e uart_num, gpio_func_pin_e rtx_pin)
{
    ...
    gpio_set_up_down_res((gpio_pin_e)rtx_pin, GPIO_PIN_PULLUP_20K);
    switch (uart_num) {
    case UART0:
