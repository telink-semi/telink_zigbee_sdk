...
{
    audio_codec_set_adc_power_mode(HIGH_POWER_CONSUMPTION);
...
{
   analog_write_reg8(0x111, (analog_read_reg8(0x111) & 0xcf) | (mode << 4));
   analog_write_reg8(0x113, (analog_read_reg8(0x113) & 0xc0) | (mode | (mode << 2) |(mode << 4)));
}
...
void audio_codec_stream0_input_config(codec_stream0_input_src_e source, audio_sample_rate_e rate)
{
    if (!(source & BIT(3)))
    {
        ...
        analog_write_reg8(0x10f, (analog_read_reg8(0x10f) & 0xf0) | 0x05);
