/********************************************************************************************************
 * @file     register_826x.h
 *
 * @brief    register definite for tlsr826x
 *
 * @author
 * @date     Dec. 1, 2016
 *
...
#define REG_ADDR8(a)					(*(volatile u8*) (IOBASE + (a)))
#define REG_ADDR16(a)					(*(volatile u16*)(IOBASE + (a)))
#define REG_ADDR32(a)					(*(volatile u32*)(IOBASE + (a)))
 ...
 *****************************************************/
#define REG_GPIO_OUT_BASE_ADDR	(0x800583)
...
static inline void irq_init(u32 irq_mask){
	reg_irq_mask = irq_mask;
}

static inline void dma_init(u32 dma_mask){
