...
{
    reg_audio_en = MASK_VAL(FLD_AUDIO_I2S_CLK_EN, i2s_clk_en, FLD_AUDIO_MC_CLK_EN, mc_clk_en);
}
...
static inline void audio_set_codec_adc_mute(void)
{
    ...
    while (reg_audio_codec_stat2_ctr & FLD_AUDIO_CODEC_ADC12_SMUTE_IN_PROG)
        ;                                                               //wait codec adc mute is completed
}
...
static inline void audio_set_codec_adc_unmute(void)
{
    ...
    while (reg_audio_codec_stat2_ctr & FLD_AUDIO_CODEC_ADC12_SMUTE_IN_PROG)
        ;                                                               //wait codec adc unmute is completed
}
...
static inline void audio_set_codec_dac_mute(void)
{
    ...
    while (reg_audio_codec_stat2_ctr & FLD_AUDIO_CODEC_DAC_SMUTE_IN_PROG)
        ;                                                           //wait codec dac mute is completed
}
...
static inline void audio_set_codec_dac_unmute(void)
{
    ...
    while (reg_audio_codec_stat2_ctr & FLD_AUDIO_CODEC_DAC_SMUTE_IN_PROG)
        ;                                                           //wait codec dac unmute is completed
}
...
static inline void audio_set_codec_adc_a_gain(codec_in_path_analog_gain_e a_gain)
{
    ...
    reg_audio_codec_mic_l_R_gain = MASK_VAL(FLD_AUDIO_CODEC_AMIC_L_GAIN, a_gain, FLD_AUDIO_CODEC_AMIC_R_GAIN, a_gain);
}
...
static inline void audio_set_codec_adc_d_gain(codec_in_path_digital_gain_e d_gain)
{
    ...
    reg_audio_adc1_gain = MASK_VAL(FLD_AUDIO_CODEC_ADC_LRGID, 1, FLD_AUDIO_CODEC_ADC_GID1, d_gain);
}
...
static inline void audio_set_codec_dac_a_gain(codec_out_path_analog_gain_e a_gain)
{
    ...
    reg_audio_codec_hpl_gain = MASK_VAL(FLD_AUDIO_CODEC_HPL_LRGO, 0, FLD_AUDIO_CODEC_HPL_GOL, a_gain);
...
static inline void audio_set_codec_dac_d_gain(codec_out_path_digital_gain_e d_gain)
{
    ...
    reg_audio_codec_dacl_gain = MASK_VAL(FLD_AUDIO_CODEC_DAC_LRGOD, 0, FLD_AUDIO_CODEC_DAC_GODL, d_gain);
