 ...
 */
#define reg_pwm0_pulse_num REG_ADDR16(REG_PWM_BASE + 0x2c)
 ...
 * BIT[0]:This bit is usually used with BIT[0] of 0x140e30. If this bit is set to 1, it means that a pulse group of PWM has been sent.An interrupt was also generated. You can manually write 1 to clear the interrupt flag.
 ...
 * BIT[8]:When the FIFO value is less than the set value, an interrupt is generated(The premise is that this interrupt has been enabled by register 0x140e32 previous).
...
#define reg_pwm_data_buf_adr    0x140e48

/**
 * PWM data fifo.0x140e48~0x140e4b.
 */
 ...
 */
#define reg_pwm_ir_fifo_data_status REG_ADDR8(REG_PWM_BASE + 0x4d)
 ...
 */
#define reg_pwm_ir_clr_fifo_data REG_ADDR8(REG_PWM_BASE + 0x4e)
...
typedef enum
{
    FLD_PEM_PWM_TASK_EN   = BIT_RNG(0, 7),
} pwm_pem_ctrl_e;


/**
 * this register configure pwm5~pwm0 dead time.
 */
#define reg_pwm_dead(i) REG_ADDR16(REG_PWM_BASE + 0x50 + (i * 2))
