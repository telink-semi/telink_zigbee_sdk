...
#define _attribute_data_sec_                            __attribute__((section(".data")))
 ...
 * 1. The sub functions in the pm_sleep_wakeup function need to use _always_inline and _attribute_ram_code_sec_optimize_o2_, as detailed in the internal comments of pm_sleep_wakeup.
