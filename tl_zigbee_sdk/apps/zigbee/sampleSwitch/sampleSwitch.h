...
/**
 *  @brief Defined for ZDD cluster attributes
 */
...
extern zcl_powerCfgAttr_t g_zcl_powerCfgAttrs;
...
#ifdef ZCL_ZBD_CONFIG
extern zcl_zbdAttr_t g_zcl_zbdAttrs;
#define zcl_zbdAttrGet()        &g_zcl_zbdAttrs
