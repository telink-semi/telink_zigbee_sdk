...
static factoryRstFn_t g_factoryRstFn = NULL;
static ev_timer_event_t *factoryRst_timerEvt = NULL;
static u8 factoryRst_powerCnt = 0;
static bool factoryRst_exist = FALSE;

static nv_sts_t factoryRst_powerCntSave(void)
{
    nv_sts_t st = NV_SUCC;
#if NV_ENABLE
...
static nv_sts_t factoryRst_powerCntRestore(void)
{
    nv_sts_t st = NV_SUCC;
#if NV_ENABLE
...
void factoryRst_init(factoryRstFn_t fn)
{
