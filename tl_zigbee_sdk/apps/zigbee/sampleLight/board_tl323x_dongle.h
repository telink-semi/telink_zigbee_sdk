...
// LED
/***************************************************************
* LED_R	        GPIO_PB0        //D2  -- red    PWM0
* LED_G	        GPIO_PB1        //D1  -- green  PWM1
* LED_B	        GPIO_PD1        //D5  -- blue   PWM2
* LED_Y	        GPIO_PD0        //D4  -- yellow
* LED_W	        GPIO_PD2        //D6  -- white
* LED_O         GPIO_PD3        //D7  -- orange
****************************************************************/
#if defined COLOR_RGB_SUPPORT && (COLOR_RGB_SUPPORT == 1)
#define LED_R                   GPIO_PB0
#define LED_G                   GPIO_PB1
#define LED_B                   GPIO_PD1
...
//Others as GPIO.
#define LED_Y                   GPIO_PD0
#define LED_W                   GPIO_PD2
#define LED_O                   GPIO_PD3
