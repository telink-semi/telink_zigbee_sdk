...
mac_appIndCb_t macAppIndCbList = {
    NULL,
    NULL,
    sampleGw_macAssocReqIndHandler
};
#endif
...
#if ((!ZBHCI_EN) && (!ZIGBEE_DIRECT_ENABLE))
...
s32 sampleGw_recoveryStart(void *arg)
{
#if ZIGBEE_DIRECT_ENABLE
...
void sampleGW_leaveCnfHandler(nlme_leave_cnf_t *pLeaveCnf)
{
    ...
    TL_ZB_TIMER_SCHEDULE(sampleGw_recoveryStart, NULL, 3 * 1000);
}
