/********************************************************************************************************
 * @file    sampleGwDirectMultiBLE.c
 *
 * @brief   This is the source file for sampleGwDirectMultiBLE
 *
 * @author  Zigbee Group
 * @date    2025
 *
...
#define PERIPHR_ATT_RX_MTU              247//23//DIRECT_ATT_MTU_RECOMMENDED  //user set value
...
const attribute_t my_Attributes[] = {
    ...
    {0,ATT_PERMISSIONS_WRITE, 16, sizeof(my_zbdTunnelData), (u8*)(size_t)(&my_zbdTunnelCharUUID), (u8*)(&my_zbdTunnelData), &app_zbdTunnelWrite, 0}, //value
    {0,ATT_PERMISSIONS_RDWR, 2,  sizeof(my_zbdTunnelName), (u8*)(size_t)(&my_zbdTunnelSemUUID), (u8*)(my_zbdTunnelName), 0, 0},
#endif
...
//////////////////////////// BLE stack Initialization  Begin //////////////////////////////////
    ...
    if (error_code1 != INIT_SUCCESS || error_code2 != INIT_SUCCESS) {
        ...
        #if (CONSOLE_ENABLE)
            tlkapi_send_string_data(APP_LOG_EN, "[APP][INI] Stack INIT ERROR 0x%04x, 0x%04x", error_code1, error_code2);
        #endif
        while(1);
    }
