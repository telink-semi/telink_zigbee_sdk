...
{
    bls_l2cap_requestConnParamUpdate (g_appBleInterval, g_appBleInterval, g_appBleLatency, CONN_TIMEOUT_4S);  // 1 S
...
void user_ble_init(bool isRetention)
{
    ...
    //when deepSleep retention wakeUp, no need initialize again, has been initialized in platform_init.
     ...
     * reConnect:  send security_request 1000mS after connection complete. If master start paring or encryption before 1000mS timeout, 
     * slave do not send security_request.
