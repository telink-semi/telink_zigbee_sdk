...
const attribute_t my_Attributes[] = {
    ...
    // 001a - 002b
    {18,ATT_PERMISSIONS_READ,2,2,(u8*)(&my_primaryServiceUUID),     (u8*)(&my_commServiceUUID), 0},
 ...
 * @return     0
 */
volatile u8 final_MTU_size = 0;
volatile u8 g_bleConnDoing = 0;
int app_host_event_callback (u32 h, u8 *para, int n)
{
    u8 event = h & 0xFF;
//  printf("app_host_event_callback,event:%d\n",event);
    switch(event)
    {
