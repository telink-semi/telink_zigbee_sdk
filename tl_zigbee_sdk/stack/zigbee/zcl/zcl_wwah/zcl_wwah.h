...
typedef struct {
    u8 *pClusterID;
    u8 numOfClusters;
} zcl_wwah_apsAckRequirementQueryRspCmd_t;
...
} classificationMask_t;

typedef struct {
    u16 deviceShort;
    s8 rssi;
    classificationMask_t mask;
} beaconSurvey_t;
...
status_t zcl_wwah_useTrustCenterForClusterCmd(u8 srcEp, epInfo_t *pDstEpInfo, u8 disableDefaultRsp, u8 seqNo, clustersToExempt_t *pCmd);
...
status_t zcl_wwah_surveyBeaconsRspCmd(u8 srcEp, epInfo_t *pDstEpInfo, u16 manufCode, u8 disableDefaultRsp, u8 seqNo, zcl_wwah_surveyBeaconsRspCmd_t *pCmd);
#define zcl_wwah_surveyBeaconsRspCmdSend(a,b,c,d,e,f)     (zcl_wwah_surveyBeaconsRspCmd((a), (b), (c), (d), (e), (f)))
