...
typedef enum {
    ...
    MGMT_NWK_BEACON_SURVEY_REQ_CLID                     = 0x003C,
    SEC_START_KEY_NEGOTIATION_REQ_CLID                  = 0x0040,
    SEC_RETRIEVE_AUTH_TOKEN_REQ_CLID                    = 0x0041,
    SEC_GET_AUTH_LEVEL_REQ_CLID	                        = 0x0042,
    SEC_SET_CFG_REQ_CLID                                = 0x0043,
    SEC_GET_CFG_REQ_CLID                                = 0x0044,
    SEC_START_KEY_UPDATE_REQ_CLID                       = 0x0045,
    SEC_DECOMMISSION_REQ_CLID                           = 0x0046,
    SEC_CHALLENGE_REQ_CLID                              = 0x0047,
    ...
    MGMT_NWK_UNSOLICITED_ENHANCED_UPDATE_NOTIFY_CLID    = 0x803B,
    MGMT_NWK_BEACON_SURVEY_RSP_CLID                     = 0x803C,
    SEC_START_KEY_NEGOTIATION_RSP_CLID                  = 0x8040,
    SEC_RETRIEVE_AUTH_TOKEN_RSP_CLID                    = 0x8041,
    SEC_GET_AUTH_LEVEL_RSP_CLID                         = 0x8042,
    SEC_SET_CFG_RSP_CLID                                = 0x8043,
    SEC_GET_CFG_RSP_CLID                                = 0x8044,
    SEC_START_KEY_UPDATE_RSP_CLID                       = 0x8045,
    SEC_DECOMMISSION_RSP_CLID                           = 0x8046,
    SEC_CHALLENGE_RSP_CLID                              = 0x8047,
} zdp_clusterId_e;
...
/**
 * @brief the structure for Clear_All_Bindings_req
 */
typedef struct {
    u8 *pTLVs;                          /*!< Clear All Bindings Req EUI64 TLV (ID = 0) */
    u8 tlvLen;
} zdo_clearAllBind_req_t;

/**
 * @brief the structure for Mgmt_Lqi_req
 */
typedef struct {
    u8 start_index;
} zdo_mgmt_lqi_req_t;
...
/**
 * @brief the structure for Mgmt_Rtg_req
 */
typedef struct {
    u8 start_index;
} zdo_mgmt_rtg_req_t;
...
/**
 * @brief the structure for Mgmt_NWK_Beacon_Survey_req
 */
typedef struct {
    u8 *pTLVs;                          /*!< Beacon Survey Configuration TLV (ID = 0) */
    u8 tlvLen;
} zdo_mgmt_nwkBeaconSurvey_req_t;


typedef struct {
    addrExt_t joinerLongAddr;
    addrExt_t dstLongAddr;
    bool relayCmd;
} zdo_sec_addrInfo_t;

/**
 * @brief the structure for Sec_Start_Key_Negotiation_req
 */
typedef struct {
    u8 *pTLVs;                          /*!< Curve25519 Public Point TLV (ID = 0) */
    u16 tlvLen;
} zdo_sec_startKeyNegoReq_t;

/**
 * @brief the structure for Sec_Retrieve_Auth_Token_req
 */
typedef struct {
    u8 *pTLVs;                          /*!< Authentication Token ID TLV (ID = 0) */
    u16 tlvLen;
} zdo_sec_retrieveAuthTokenReq_t;

/**
 * @brief the structure for Sec_Get_Authentication_Level_req
 */
typedef struct {
    u8 *pTLVs;                          /*!< Target IEEE Address TLV (ID = 0) */
    u16 tlvLen;
} zdo_sec_getAuthLevelReq_t;

/**
 * @brief the structure for Sec_Set_Configuration_req
 */
typedef struct {
    u8 *pTLVs;                          /*!< Next PAN ID Global TLV, Next Channel Change Global TLV, Configuration Parameters Global TLV */
    u16 tlvLen;
} zdo_sec_setConfigReq_t;

/**
 * @brief the structure for Sec_Set_Configuration_resp
 */
typedef struct {
    u8 seqNum;
    u8 overallSta;
    u8 *pTLVs;
} zdo_sec_setConfigResp_t;

/**
 * @brief the structure for Sec_Get_Configuration_req
 */
typedef struct {
    u8 *tlvId;
    u8 tlvCnt;
} zdo_sec_getConfigReq_t;

/**
 * @brief the structure for Sec_Get_Configuration_resp
 */
typedef struct {
    u8 seqNum;
    u8 overallSta;
    u8 *pTLVs;
} zdo_sec_getConfigResp_t;

/**
 * @brief the structure for Sec_Start_Key_Negotiation_req
 */
typedef struct {
    u8 *pTLVs;                          /*!< Selected Key Negotiation Method TLV (ID = 0), Fragmentation Parameters Global TLV (ID = 71) */
    u16 tlvLen;
} zdo_sec_startKeyUpdateReq_t;

/**
 * @brief the structure for Sec_Challenge_req
 */
typedef struct {
    u8 *pTLVs;                          /*!< APS Frame Counter Challenge TLV (ID = 0) */
    u16 tlvLen;
} zdo_sec_challengeReq_t;

/**
 * @brief the structure for Sec_Decommission_req
 */
typedef struct {
    u8 *pTLVs;                          /*!< Device EUI64 List TLV (ID = 0) */
    u16 tlvLen;
} zdo_sec_decommissionReq_t;
...
/**
 * @brief the structure for Match_Desc_rsp
 */
typedef struct _attribute_packed_ {
    u8 seq_num;                         /*! Sequence number which same with the request value */
    u8 status;                          /*! Response status */
...
typedef zdo_bind_resp_t                 zdo_clear_all_bind_resp_t;
...
typedef struct _attribute_packed_ {
    u8 seq_num;                         /*! Sequence number which same with the request value */
    u8 status;                          /*! Response status */
    u8 routing_tbl_entries;
    u8 start_index;
    u8 routing_tbl_lst_cnt;
    routing_tbl_lst_t routing_tbl_lst[1];
} zdo_mgmt_rtg_resp_t;
...
typedef struct {
    ...
    union {
        ...
        addrExt_t dst_ext_addr;         //!< Destination extended address. Specify this field if extended address mode is applied, i.e. dstAddrMode equals EXT_ADDR_MODE
    };
    addrExt_t joinerLongAddr;
...
/**
 * @brief  Interface called when receive clear all bindings request message from a remote device
 *
 * @param  buf - received packet info with APS data indication primitive
 *
 * @return none
 */
void zdo_clearAllBindIndicate(void *buf);
...
/**
 * @brief  Interface to process MGMT rtg request CMD.
 *
 * @param  buf - received packet info with APS data indication primitive
 *
 * @return none
...
/**
 * @brief  Interface invoked when receive MGMT_NWK_UPDATE_REQ_CLID, process channel update,
 *         attributes change or ED scan requests
 *
 * @param  buf - received packet info with APS data indication primitive
 *
 * @return none
...
/**
 * @brief  Interface invoked when receive MGMT_NWK_BEACON_SURVEY_REQ_CLID
 *
 * @param  buf - received packet info with APS data indication primitive
 *
 * @return none
 */
void zdo_mgmtNwkBeaconSurveyIndicate(void *buf);

/**
 * @brief  Interface invoked when receive SEC_START_KEY_NEGOTIATION_REQ_CLID
 *
 * @param  buf - received packet info with APS data indication primitive
 *
 * @return none
 */
void zdo_secStartKeyNegoIndicate(void *buf);

/**
 * @brief  Interface invoked when receive SEC_RETRIEVE_AUTH_TOKEN__REQ_CLID
 *
 * @param  buf - received packet info with APS data indication primitive
 *
 * @return none
 */
void zdo_secRetrieveAuthTokenIndicate(void *buf);

/**
 * @brief  Interface invoked when receive SEC_START_KEY_UPDATE_REQ_CLID
 *
 * @param  buf - received packet info with APS data indication primitive
 *
 * @return none
 */
void zdo_secStartKeyUpdateIndicate(void *buf);

/**
 * @brief  Interface invoked when receive SEC_GET_AUTHENTICATION_LEVEL_REQ_CLID
 *
 * @param  buf - received packet info with APS data indication primitive
 *
 * @return none
 */
void zdo_secGetAuthLevelIndicate(void *buf);

/**
 * @brief  Interface invoked when receive SEC_SET_CONFIGURATION_REQ_CLID
 *
 * @param  buf - received packet info with APS data indication primitive
 *
 * @return none
 */
void zdo_secSetConfigIndicate(void *buf);

/**
 * @brief  Interface invoked when receive SEC_GET_CONFIGURATION_REQ_CLID
 *
 * @param  buf - received packet info with APS data indication primitive
 *
 * @return none
 */
void zdo_secGetConfigIndicate(void *buf);

/**
 * @brief  Interface invoked when receive SEC_CHALLENGE_REQ_CLID
 *
 * @param  buf - received packet info with APS data indication primitive
 *
 * @return none
 */
void zdo_secChallengeIndicate(void *buf);

/**
 * @brief  Interface invoked when receive SEC_DECOMMISSION_REQ_CLID
 *
 * @param  buf - received packet info with APS data indication primitive
 *
 * @return none
 */
void zdo_secDecommissionIndicate(void *buf);
 ...
 * @return none
 */
void zdo_mgmtNwkUpdateNotifyRspSend(void *buf);

/**
 * @brief  Interface to prepare and send mgmt_nwk_beacon_survey_response.
 *
 * @param  buf - result of active scan
 *
 * @return none
 */
void zdo_mgmtNwkBeaconSurveyRspSend(void *buf);
 ...
 * @param  buf - call back data address
 *
 * @return none
 */
void zdp_cb_process(u8 tsn, void *buf);
