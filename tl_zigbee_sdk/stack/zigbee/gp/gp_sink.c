...
void gp_sinkInit(u8 endpoint)
{
    ...
    zclGpAttr_gpsFunc[0] = U32_BYTE0(GPS_FUNCTIONALITY);
    zclGpAttr_gpsFunc[1] = U32_BYTE1(GPS_FUNCTIONALITY);
    zclGpAttr_gpsFunc[2] = U32_BYTE2(GPS_FUNCTIONALITY);

    zclGpAttr_gpsActiveFunc[0] = U32_BYTE0(GPS_ACTIVE_FUNCTIONALITY);
    zclGpAttr_gpsActiveFunc[1] = U32_BYTE1(GPS_ACTIVE_FUNCTIONALITY);
    zclGpAttr_gpsActiveFunc[2] = U32_BYTE2(GPS_ACTIVE_FUNCTIONALITY);
}
