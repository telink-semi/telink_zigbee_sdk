...
void gp_proxyInit(void)
{
    ...
    zclGpAttr_gppFunc[0] = U32_BYTE0(GPP_FUNCTIONALITY);
    zclGpAttr_gppFunc[1] = U32_BYTE1(GPP_FUNCTIONALITY);
    zclGpAttr_gppFunc[2] = U32_BYTE2(GPP_FUNCTIONALITY);

    zclGpAttr_gppActiveFunc[0] = U32_BYTE0(GPP_ACTIVE_FUNCTIONALITY);
    zclGpAttr_gppActiveFunc[1] = U32_BYTE1(GPP_ACTIVE_FUNCTIONALITY);
    zclGpAttr_gppActiveFunc[2] = U32_BYTE2(GPP_ACTIVE_FUNCTIONALITY);
}
